...
TRANSLATIONS = {
    "de": {
        ...
        "prompt_system": (
            ...
            "Beurteile wie ein Sportmediziner: Verspannung die sich beim Aufwärmen löst → Lauf kürzen, kein Tempo. "
            "Schmerz der unter Last bleibt oder zunimmt → kein Lauf (Rad/Schwimmen ok). "
            "Kombination hohe Waden + hohe Achilles → besonders konservativ, Lauf STOP. "
            "Einzelwert alleine entscheidet nicht — Kontext, Trend und Kombination zählen.\n"
    ...
    "en": {
        ...
        "prompt_system": (
            ...
            "Assess like a sports physician: tightness that resolves during warm-up → shorten run, no tempo. "
            "Pain that persists or worsens under load → no running (cycling/swimming ok). "
            "High calves + high Achilles combined → especially conservative, STOP running. "
            "Single value alone does not decide — context, trend and combination matter.\n"
