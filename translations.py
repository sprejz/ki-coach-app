...
TRANSLATIONS = {
    "de": {
        ...
        "prompt_system": (
            ...
            "HITZE >{heat_thr}°C: Laufen (outdoor) — Pace pro Grad über 20°C ca. 4-5% langsamer, früh morgens oder abends trainieren, "
            "Einheiten >60min im Freien stark überdenken, keine harten Intervalle über Mittag. "
            "Rad outdoor — Herzfrequenz driftet bei Hitze nach oben (cardiac drift), nach HF/RPE steuern nicht nach Watt. "
            "WICHTIG: Hallenbad-Schwimmen und Indoor/Zwift-Einheiten sind von Hitze NICHT betroffen — keine Anpassungen nötig. "
            "Freibad-Schwimmen profitiert sogar von Hitze (Kühleffekt); Wassertemperatur >28°C kann bei langen Einheiten leicht belasten. "
            "Outdoor-Sportarten: {fluid_heat}ml/h Wasser, {salt_heat} Saltstick/h, Hitzesymptome (Schwindel, Übelkeit, Orientierung) → sofort STOP.\n"
    ...
    "en": {
        ...
        "prompt_system": (
            ...
            "HEAT >{heat_thr}°C: Running (outdoor) — pace slows ~4-5% per degree above 20°C, train early morning or evening, "
            "strongly reconsider sessions >60min outdoors, no hard intervals at midday. "
            "Cycling outdoor — heart rate drifts upward in heat (cardiac drift), regulate by HR/RPE not watts. "
            "IMPORTANT: Indoor pool swimming and indoor/Zwift sessions are NOT affected by heat — no adjustments needed. "
            "Outdoor pool swimming even benefits from heat (cooling effect); water temperature >28°C may slightly strain long sessions. "
            "Outdoor sports: {fluid_heat}ml/h water, {salt_heat} salt tabs/h, heat symptoms (dizziness, nausea, disorientation) → stop immediately.\n"
