...
SCHEMA = {
    ...
    "properties": {
        "gesamturteil": {
            ...
            "description": "Gesamtlage. 'pause' heißt: heute kein Training.",
        },
        "leitsymptom": {
            "type": "string",
            "description": "Das auffälligste Signal mit Wert, z.B. 'Achilles rechts 4/10'. Leer wenn unauffällig.",
        },
        "sportarten": {
            "type": "array",
    ...
    "required": ["gesamturteil", "leitsymptom", "sportarten", "alternativen", "erholung"],
    "additionalProperties": False,
}
...
def build_input(
    *,
    ...
    lines.append(f"- Krankheitssymptome: {koerper.get('symptome', 'keine')}")
