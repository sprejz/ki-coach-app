...
hier ist nur der Prompt wirklich radspezifisch, und der liegt jetzt als eine
...
SPORT = "Rad"
_PROMPT_PATH = Path(__file__).parent / "architect_bike.md"


def run(*, athlete: dict, workout: dict, auftrag: dict, wetter_zeile: str = "",
        sport: str = "", model: str = HAIKU) -> dict:
    # `sport` wird hier nicht ausgewertet (dieses Modul ist schon radspezifisch)
