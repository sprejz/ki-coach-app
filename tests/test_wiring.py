...
FAKE_COACH = {
    ...
    "sportarten": [{"sport": "Laufen", "badge": "SKIP", "details": "Achilles raus",
                    "beschreibung": "❌ gestrichen", "ernaehrung": "normal",
                    "tp_struktur": None, "distanz_m": None}],
...
async def main():
    ...
    ergebnis = await app._try_agent_check(
        ...
        tp_workouts=[{"id": "1", "sport": "Run", "title": "Schwellenlauf",
